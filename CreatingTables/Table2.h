...
Table2::Table2(std::string name, std::string title)
{
  ...
  // Add the string for the directory on the lxplus Server
  string hypUtilsDir = "/afs/cern.ch/user/e/ejobst/Hypertriton_analysis/Data";
  ...
  tree->Branch("EPangleV0A", &EPangleV0A);
  tree->Branch("EPangleV0C", &EPangleV0C);
...
void Table2::Fill(const RHyperTritonHe3pi &RHyper, const RCollision &RColl, bool properHe3Mass)
{
  ...
  EPangleV0A = RColl.fEPangleV0A;
  EPangleV0C = RColl.fEPangleV0C;
  PxHe3 = RHyper.fPxHe3;
  PyHe3 = RHyper.fPyHe3;
  PzHe3 = RHyper.fPzHe3;
  PxPi = RHyper.fPxPi;
